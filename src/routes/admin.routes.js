...
router.patch('/users/:userId/subscription-access', adminController.updateUserSubscriptionAccess);
router.patch('/tenants/:tenantId/storage-limit', adminController.updateTenantStorageLimit);
